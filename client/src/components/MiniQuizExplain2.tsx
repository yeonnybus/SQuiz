...
const FormContainer = styled.div`
  ...
  width: 90%; /* 부모 요소의 너비를 따라 가로로 전체 너비를 차지 */
  margin-top: 5%;
      ...
      <Grid item xs={6}>
        <FormContainer>
          <InlineS2>
            <Label>Q16.</Label>
            <LabelMini2>
              다음 연산 중 유저 모드에서만 허용되어야 하는 것들을 골라라
            </LabelMini2>
          </InlineS2>
          ...
          >
            <Grid item xs={6}>
              <LabelMini>ㅇㄹㅇ</LabelMini>
            </Grid>
            <Grid item xs={6}>
              <LabelMini>ㄱㄱㄱ</LabelMini>
            </Grid>
            <Grid item xs={6}>
              <LabelMini>ㅁㄴㄷ</LabelMini>
            </Grid>
            <Grid item xs={6}>
              <LabelMini>ㄹㄹㄹ</LabelMini>
            </Grid>
          </Grid>
          <Line />
          <LabelMini3>해설</LabelMini3>
          <LabelMini4>유저 모드에서 허용되어야 하는 연산은...</LabelMini4>
        </FormContainer>
      </Grid>
      <Grid item xs={6}>
        <FormContainer>
